...
export const NailBase = () => {
    ...
    const getAllProducts = useCallback(async () => {
        ...
        try {
            ...
            const productsResponse = await productService.getAllProductsByType(pageNumber, "Nail base")
    ...
    return (
        <Container>
              <div className="banner-img">
                    ...
                    <div className="top-left-title">Nail Base</div>
                    <div className="top-left-content">
                    Say goodbye to chipped and dull nail color with our range of nail base products. Our advanced base coats are specially designed to provide a strong and even foundation for your nail polish, ensuring that your color lasts longer and looks more vibrant. Plus, our nourishing formulas help to strengthen and protect your nails, leaving them looking healthy and beautiful.
                    </div>
                </div>
