    ...
    return (
        <Container>
              <div className="banner-img">
                    ...
                    <div className="top-left-title">Top Coat</div>
                    <div className="top-left-content">
                    Put the finishing touch on your perfect manicure with our high-gloss topcoat. Our formula provides a long-lasting, chip-resistant finish that seals in your favorite nail color and adds an extra layer of protection. With its fast-drying formula, you can say goodbye to smudges and hello to perfectly polished nails.
                    </div>
                </div>
