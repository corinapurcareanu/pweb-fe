...
export const NailPolish = () => {
    ...
    const getAllProducts = useCallback(async () => {
        ...
        try {
            ...
            const productsResponse = await productService.getAllProductsByType(pageNumber, "Nail Polish")
    ...
    return (
        <Container>
              <div className="banner-img">
                    ...
                    <div className="top-left-title">Nail Polish</div>
                    <div className="top-left-content">
                    Add a pop of color to your life with our vibrant range of nail polishes. Our long-lasting formula provides a high-shine finish and ensures that your nails stay looking flawless for days. With a wide range of shades to choose from, you can find the perfect color to match your style and mood.
                    </div>
                </div>
