...
export const Gloss = () => {
    ...
    const getAllProducts = useCallback(async () => {
        ...
        try {
            ...
            const productsResponse = await productService.getAllProductsByType(pageNumber, "Gloss")
    ...
    return (
        <Container>
              <div className="banner-img">
                    ...
                    <div className="top-left-title">Gloss</div>
                    <div className="top-left-content">
                    Make your lips pop with our range of lip glosses. Our formulas are enriched with nourishing ingredients that help to keep your lips looking soft and supple, while also providing a high-shine finish. Plus, our range of shades and finishes makes it easy to find the perfect product for any occasion, from a casual day out to a glamorous evening event.
                    </div>
                </div>
