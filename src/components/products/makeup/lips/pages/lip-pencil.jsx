...
export const LipPencil = () => {
    ...
    const getAllProducts = useCallback(async () => {
        ...
        try {
            ...
            const productsResponse = await productService.getAllProductsByType(pageNumber, "Lip Pencil")
    ...
    return (
        <Container>
              <div className="banner-img">
                    ...
                    <div className="top-left-title">Lip Pencil</div>
                    <div className="top-left-content">
                    Create the perfect pout with our range of lip pencils. Our formulas are designed to help define and enhance your lips, while also providing long-lasting wear. With a variety of shades to choose from, it's easy to find the perfect product to complement any lipstick or gloss. Plus, our smooth and creamy formula glides on effortlessly, making it easy to achieve a flawless finish every time.
                    </div>
                </div>
