...
export const LipBalm = () => {
    ...
    const getAllProducts = useCallback(async () => {
        ...
        try {
            ...
            const productsResponse = await productService.getAllProductsByType(pageNumber, "Lip Balm")
    ...
    return (
        <Container>
              <div className="banner-img">
                    ...
                    <div className="top-left-title">Lip Balm</div>
                    <div className="top-left-content">
                    Say goodbye to dry, chapped lips with our range of lip balms. Our formulas are designed to provide long-lasting hydration, while also protecting your lips from the elements. Plus, our range of scents and flavors make it easy to find the perfect product for you, whether you're looking for something sweet or refreshing.
                    </div>
                </div>
