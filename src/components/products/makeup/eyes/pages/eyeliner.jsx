...
export const Eyeliner = () => {
    ...
    const getAllProducts = useCallback(async () => {
        ...
        try {
            ...
            const productsResponse = await productService.getAllProductsByType(pageNumber, "Eyeliner")
    ...
    return (
        <Container>
              <div className="banner-img">
                    ...
                    <div className="top-left-title">Eyeliner</div>
                    <div className="top-left-content">
                    Define and accentuate your eyes with our premium eye liner. Our liner is perfect for creating bold and defined eye looks, while also being easy to blend for a natural finish. Plus, our formula is enriched with nourishing ingredients to promote healthy skin and prevent irritation or dryness.
                    </div>
                </div>
