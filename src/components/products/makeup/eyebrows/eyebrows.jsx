...
export const Eyebrows = () => {
    ...
    const getAllProducts = useCallback(async () => {
        ...
        try {
            ...
            const productsResponse = await productService.getAllProductsByType(pageNumber, "Eyebrows Gel, Eyebrows Pencil")
    ...
    return (
        <Container>
              <div className="banner-img">
                    <img src="https://media.ourfashionpassion.com/wp-content/uploads/2022/04/27124211/f08690464a5a6e9c58f0cfe2401c591b.jpg" />
                    <div className="top-left-title">Eyebrows</div>
                    <div className="top-left-content">
                    Get the perfect brows every time with our line of premium eyebrow products. From pencils to gels, our products are designed to help you achieve the perfect shape, color, and texture, while also nourishing and protecting your brow hairs.
                    </div>
                </div>
                ...
                <table>
                    <tbody>
                        ...
                        <td className='td-padding'>
                            <button className="menu-makeup" onClick={() => window.location.pathname = '/make-up/eyebrows/eyebrows-gel'}>
                            Eyebrows gel
                            </button>
                        </td>
                        <td className='td-padding'>
                            <button className="menu-makeup" onClick={() => window.location.pathname = '/make-up/eyebrows/eyebrows-pencil'}>
                            Eyebrows pencil
                            </button>
                        </td>
                        </tr>
