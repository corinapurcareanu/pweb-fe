...
export const FaceCare = () => {
    ...
    const getAllProducts = useCallback(async () => {
        ...
        try {
            ...
            const productsResponse = await productService.getAllProductsByType(pageNumber, " Day cream, Face mask, Night cream")
    ...
    return (
        <Container>
              <div className="banner-img">
                    <img src="https://hips.hearstapps.com/hmg-prod/images/skincare-1588698347.png?crop=1.00xw:0.752xh;0,0.175xh&resize=1200:*" />
                    <div className="top-left-title">Face Care</div>
                    <div className="top-left-content">
                        Say goodbye to dry, dull skin with our new face cream! Our formula is specially designed to nourish and hydrate your skin, leaving it feeling soft and supple all day long. With regular use, you'll notice a brighter, more radiant complexion that's the envy of all your friends. So why wait? Try our face cream today and experience the difference for yourself!
                    </div>
                </div>
            <div>
                <table>
                <tbody>
                    ...
                    <td className='td-padding'>
                        <button className="menu-skincare" onClick={() => window.location.pathname = '/skin-care/face-care/day-cream'}>
                        Day Cream
                        </button>
                    </td>
                    <td className='td-padding'>
                        <button className="menu-skincare" onClick={() => window.location.pathname = '/skin-care/face-care/night-cream'}>
                        Night Cream
                        </button>
                    </td>
                    <td className='td-padding'>
                        <button className="menu-skincare" onClick={() => window.location.pathname = '/skin-care/face-care/face-mask'}>
                        Face mask
                        </button>
                    </td>
                    </tr>
