...
export const HairGel = () => {
    ...
    const getAllProducts = useCallback(async () => {
        ...
        try {
            ...
            const productsResponse = await productService.getAllProductsByType(pageNumber, "Hair Gel")
    ...
    return (
        <Container>
              <div className="banner-img">
                    ...
                    <div className="top-left-title">Hair Gel</div>
                    <div className="top-left-content">
                    Elevate your hair game with our line of styling gels. From medium to strong hold, they're perfect for creating a range of styles, from full-bodied curls to sleek, straight looks, while also promoting healthy hair growth and adding shine
                    </div>
                </div>
