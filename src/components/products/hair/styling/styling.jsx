...
export const Styling = () => {
    ...
    const getAllProducts = useCallback(async () => {
        ...
        try {
            ...
            const productsResponse = await productService.getAllProductsByType(pageNumber, "Hair gel, Hair spray, Hair wax")
    ...
    return (
        <Container>
              <div className="banner-img">
                    <img src="https://hips.hearstapps.com/hmg-prod/images/person-styling-hair-royalty-free-image-1608056805." />
                    <div className="top-left-title">Styling</div>
                    <div className="top-left-content">
                    Elevate your hair game with our line of styling products. From texturizing to defining, they're perfect for creating a range of styles, from full-bodied curls to sleek, straight looks, while also nourishing and strengthening your hair.
                    </div>
                </div>
            <div>
                <table>
                <tbody>
                    ...
                    <td className='td-padding'>
                        <button className="menu-hair" onClick={() => window.location.pathname = '/hair/styling/hair-gel'}>
                        Hair gel
                        </button>
                    </td>
                    <td className='td-padding'>
                        <button className="menu-hair" onClick={() => window.location.pathname = '/hair/styling/hair-spray'}>
                        Hair spray
                        </button>
                    </td>
                    <td className='td-padding'>
                        <button className="menu-hair" onClick={() => window.location.pathname = '/hair/styling/hair-wax'}>
                        Hair wax
                        </button>
                    </td>
                    </tr>
