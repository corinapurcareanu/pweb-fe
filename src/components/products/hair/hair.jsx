...
export const Hair = () => {
    ...
    const getAllProducts = useCallback(async () => {
        ...
        try {
            ...
            const productsResponse = await productService.getAllProductsByType(pageNumber, "Hair brush, Hair pins, Hair tie, Hair balm, Hair mask, Hair oil, Shampoo, Hair gel, Hair spray, Hair wax")
    ...
    return (
        <Container>
              <div className="banner-img">
                <img src="https://www.theultrasoft.in/wp-content/uploads/2018/11/banner-Hair-care-a.jpg"/>
                <div className="top-left-title">Hair</div>
                <div className="top-left-content">
                    Bring your hair back to life with our line of restorative shampoos and conditioners. Packed with vitamins and minerals, they'll nourish your hair from root to tip, leaving it looking and feeling healthy and strong
                </div>
            </div>
                        <div>
             <table>
                <tbody>
                    ...
                    <td className='td-padding'>
                        <button className="menu-hair" onClick={() => window.location.pathname = '/hair/hair-care'}>
                        Hair Care
                        </button>
                    </td>
                    <td className='td-padding'>
                        <button className="menu-hair" onClick={() => window.location.pathname = '/hair/accesories'}>
                        Accesories
                        </button>
                    </td>
                    <td className='td-padding'>
                        <button className="menu-hair" onClick={() => window.location.pathname = '/hair/styling'}>
                        Styling
                        </button>
                    </td>
                    </tr>
