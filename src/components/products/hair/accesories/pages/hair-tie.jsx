...
export const HairTie = () => {
    ...
    const getAllProducts = useCallback(async () => {
        ...
        try {
            ...
            const productsResponse = await productService.getAllProductsByType(pageNumber, "Hair tie")
    ...
    return (
        <Container>
              <div className="banner-img">
                    ...
                    <div className="top-left-title">Hair Ties</div>
                    <div className="top-left-content">
                    Transform your hair routine with our line of innovative hair ties. Made with advanced technology and high-quality materials, they're designed to stay put, no matter what you're doing, while also minimizing hair breakage and damage.
                    </div>
                </div>
