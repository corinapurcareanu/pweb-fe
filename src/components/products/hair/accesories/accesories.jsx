...
export const Accesories = () => {
    ...
    const getAllProducts = useCallback(async () => {
        ...
        try {
            ...
            const productsResponse = await productService.getAllProductsByType(pageNumber, "Hair Brush, Hair Pins, Hair Tie")
    ...
    return (
        <Container>
              <div className="banner-img">
                    <img src="https://m.media-amazon.com/images/I/710qYHBhNJL._SY355_.jpg" />
                    <div className="top-left-title">Accesories</div>
                    <div className="top-left-content">
                    Get creative with our line of versatile hair accessories. From hair combs to hairpins, they're perfect for creating unique and intricate hairstyles that are sure to turn heads.
                    </div>
                </div>
            <div>
                <table>
                <tbody>
                    ...
                    <td className='td-padding'>
                        <button className="menu-hair" onClick={() => window.location.pathname = '/hair/accesories/hair-tie'}>
                        Hair tie
                        </button>
                    </td>
                    <td className='td-padding'>
                        <button className="menu-hair" onClick={() => window.location.pathname = '/hair/accesories/hair-brush'}>
                        Hair brush
                        </button>
                    </td>
                    <td className='td-padding'>
                        <button className="menu-hair" onClick={() => window.location.pathname = '/hair/accesories/hair-pins'}>
                        Hair pins
                        </button>
                    </td>
                    </tr>
