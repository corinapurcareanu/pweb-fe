...
export const Shampoo = () => {
    ...
    const getAllProducts = useCallback(async () => {
        ...
        try {
            ...
            const productsResponse = await productService.getAllProductsByType(pageNumber, "Shampoo")
    ...
    return (
        <Container>
              <div className="banner-img">
                    ...
                    <div className="top-left-title">Shampoo</div>
                    <div className="top-left-content">
                    Experience the luxury of our line of premium shampoos. Made with high-quality ingredients and enriched with nourishing oils and extracts, they're designed to provide the ultimate in hair care, leaving your locks looking and feeling healthy, silky, and shiny.
                    </div>
                </div>
