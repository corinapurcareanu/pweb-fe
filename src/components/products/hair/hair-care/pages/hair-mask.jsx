...
export const HairMask = () => {
    ...
    const getAllProducts = useCallback(async () => {
        ...
        try {
            ...
            const productsResponse = await productService.getAllProductsByType(pageNumber, "Hair mask")
    ...
    return (
        <Container>
              <div className="banner-img">
                    ...
                    <div className="top-left-title">Hair Mask</div>
                    <div className="top-left-content">
                    Experience the luxury of our line of premium hair masks. Made with high-quality ingredients and enriched with nourishing oils and extracts, it's designed to provide the ultimate in hair care, leaving your locks looking and feeling healthy, radiant, and beautiful.
                    </div>
                </div>
