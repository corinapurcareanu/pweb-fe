...
export const HairCare = () => {
    ...
    const getAllProducts = useCallback(async () => {
        ...
        try {
            ...
            const productsResponse = await productService.getAllProductsByType(pageNumber, "Hair balm, Hair mask, Hair oil, Shampoo")
    ...
    return (
        <Container>
              <div className="banner-img">
                    <img src="https://post.healthline.com/wp-content/uploads/2022/07/best-natural-shampoos-to-try-1200x628-facebook-1200x628.jpg" />
                    <div className="top-left-title">Hair Care</div>
                    <div className="top-left-content">
                    Get salon-worthy results at home with our line of professional-grade hair care products. Designed to meet the needs of all hair types and textures, they're perfect for achieving the perfect look, whether you're going for a natural, effortless style or a glam, red-carpet look
                    </div>
                </div>
            <div>
                <table>
                <tbody>
                    ...
                    <td className='td-padding'>
                        <button className="menu-hair" onClick={() => window.location.pathname = '/hair/hair-care/hair-balm'}>
                        Hair balm
                        </button>
                    </td>
                    <td className='td-padding'>
                        <button className="menu-hair" onClick={() => window.location.pathname = '/hair/hair-care/hair-mask'}>
                        Hair mask
                        </button>
                    </td>
                    <td className='td-padding'>
                        <button className="menu-hair" onClick={() => window.location.pathname = '/hair/hair-care/hair-oil'}>
                        Hair oil
                        </button>
                    </td>
                    <td className='td-padding'>
                        <button className="menu-hair" onClick={() => window.location.pathname = '/hair/hair-care/shampoo'}>
                        Shampoo
                        </button>
                    </td>
                    </tr>
